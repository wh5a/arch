...
export CHROMIUM_USER_FLAGS="--enable-indexed-database --enable-privacy-blacklists --omnibox-popup-count=15 --enable-experimental-extension-apis --enable-webgl --always-enable-dev-tools --purge-memory-button --allow-scripting-gallery --enable-click-to-play --disable-accelerated-compositing --disable-accelerated-2d-canvas --enable-top-sites"
